...
public class BlackJackGame {
    ...
    // some const.
    static final int INITIAL_DEFAULT = 3;
    static final int LOWER_BOUND = 2;
    static final int UPPER_BOUND = 110;
    ...
    private static void announceWinner(ArrayList<Players> arr, int bank){
        System.out.println("\n");
        System.out.println("-------------------------------------------------");
        int key = -1;
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("How many initial chips? (Not too much, default = %d. Number which larger than %d or less than %d will be invaild):\n", INITIAL_DEFAULT, LOWER_BOUND, UPPER_BOUND);
        int givenChips = in.nextInt();
        int chips = setNumbers(givenChips, LOWER_BOUND, UPPER_BOUND);
        System.out.printf("How many paticipants? (Not too much, default = %d. Number which larger than %d or less than %d will be invaild):\n", INITIAL_DEFAULT, LOWER_BOUND, UPPER_BOUND);
